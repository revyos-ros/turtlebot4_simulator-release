...
Name:           ros-jazzy-turtlebot4-simulator
Version:        2.0.2
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS turtlebot4_simulator package

License:        Apache 2.0
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-jazzy-turtlebot4-gz-bringup
Requires:       ros-jazzy-turtlebot4-gz-gui-plugins
Requires:       ros-jazzy-turtlebot4-gz-toolbox
Requires:       ros-jazzy-ros-workspace
BuildRequires:  ros-jazzy-ament-cmake
BuildRequires:  ros-jazzy-turtlebot4-gz-bringup
